...
class FnapyManager(object):
    ...
    def __init__(self, connection):
        ...
        self.offers_update_xml = None
        self.offers_query_xml = None
        self.orders_update_xml = None
        self.pricing_query_xml = None
        self.carriers_query_xml = None
        self.batch_status_xml = None
        self.messages_query_xml = None
        self.messages_update_xml = None
        self.shop_invoices_query_xml = None
        self.incidents_update_xml = None
    ...
    def authenticate(self):
        ...
        auth_xml = etree.tostring(auth, **XML_OPTIONS)
        response = requests.post(URL + 'auth', auth_xml, headers=HEADERS)
